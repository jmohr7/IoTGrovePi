...
namespace ConnectTheDotsRPiPub
{
    ...
    public class AppSettings
    {
        ...
        const string ServicebusNamespaceDefault = ConnectionStrings.ServicebusNamespaceDefault;
        const string EventHubNameDefault = ConnectionStrings.EventHubNameDefault;
        const string KeyNameDefault = ConnectionStrings.KeyNameDefault;
        const string KeyDefault = ConnectionStrings.KeyDefault;
        const string DisplayNameDefault = ConnectionStrings.DisplayNameDefault;
        const string OrganizationDefault = ConnectionStrings.OrganizationDefault;
        const string LocationDefault = ConnectionStrings.LocationDefault;
